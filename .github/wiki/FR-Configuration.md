...
| `TESLA_AUTH_BASE` | `https://auth.tesla.com/oauth2/v3` | URL de base OAuth Tesla — remplie automatiquement par le wizard ; à modifier uniquement si Tesla change son endpoint |
