...
| Raspberry Pi 3 | 1 Go | plus pris en charge ¹ |

¹ Les Raspberry Pi 3 et antérieurs (ARM 32 bits) ne sont plus pris en charge depuis la v3.51.0 : Node.js ne publie plus d'images ARMv7 à partir de la version 24.
