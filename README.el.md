...
| **Χάρτης θερμότητας** (v3.38.0) | Γεωγραφικός χάρτης θερμότητας με εναλλάξιμα επίπεδα: διαδρομές (πυκνότητα αφετηρίας/προορισμού), φορτίσεις και καθορισμένα σημεία φόρτισης — επιλέξιμο εύρος χρόνου, χωρίς εξωτερικά πρόσθετα χάρτη |
