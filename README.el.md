...
| **Φόρτιση με ηλιακό πλεόνασμα** (v3.44.0) | Φόρτιση μόνο με ηλιακό πλεόνασμα: διαβάζει το πλεόνασμα από το Home Assistant και υπολογίζει το συνιστώμενο ρεύμα φόρτισης — «Εφαρμογή τώρα» ορίζει το ρεύμα και ξεκινά/σταματά (Fleet API). Πλήρως τοπικά, χωρίς cloud |
