...
- **Doku-Stand:** **Ladeplaner (v3.42.0)** vollständig synchronisiert (README ×7, Handbuch 6 Sprachen, Wiki 7 Sprachen, Marketing-Site PR #4). **Kostensplit (v3.43.0):** README ×7 + Handbuch DE/EN (DE-only Feature). **PV-Überschuss (v3.44.0):** README ×7 + Handbuch 6 Sprachen. **Offen:** Wiki + Marketing-Site-Erwähnung für v3.43.0/v3.44.0 (separate Repos, folgen). **Regel (Sven): Doku + Marketing-Site immer im selben Arbeitsgang wie das Feature — nie auf einen Sammel-Sync verschieben.**
