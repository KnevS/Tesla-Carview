...
- **Doku-Stand:** **Ladeplaner (v3.42.0)** vollständig synchronisiert (README ×7, Handbuch 6 Sprachen, GitHub-Wiki 7 Sprachen gepusht, Marketing-Site `teslaview-web` PR #4). **Kostensplit (v3.43.0):** README ×7 + Handbuch DE/EN gepflegt (Feature ist DE-only); **offen:** Wiki + Marketing-Site-Erwähnung (separate Repos, folgen). **Regel (Sven): Doku + Marketing-Site immer im selben Arbeitsgang wie das Feature — nie auf einen Sammel-Sync verschieben.**
