...
└── Raspberry Pi 3 ή παλιότερο
      → Επιλογή A: USB SSD (USB 2.0, πιο αργό από Pi 4/5)
        ή: Αγοράστε νεότερο Pi — το Pi 4/5 είναι καλύτερη επένδυση
```
...
- Raspberry Pi 4 ή 5 (το Pi 3 λειτουργεί με επιπλέον προσπάθεια)
