...
2. Eine neue Application anlegen:
   ...
   - **Allowed Origins**: `https://tesla.iland.krische.com`
   - **Allowed Redirect URIs**: `https://tesla.iland.krische.com/api/auth/callback`
...
(oder direkt: `https://tesla.iland.krische.com/api/auth/tesla/login`).
