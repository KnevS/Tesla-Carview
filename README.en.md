...
| **Company-car tax** (v3.45.0) | 1% rule vs. logbook method for the taxable benefit — with a date-dependent EV rate (0.25%/0.5%/1%, gross-list-price cap by acquisition date). Guidance calculation, company cars only, German-language |
