...
Thank you</pre>
    ...
    <!-- Spendenaufruf -->
    <section class="space-y-4 border-t border-gray-700 pt-8">
      <h2 class="text-xl font-bold">❤️ Wenn dir die App etwas wert ist</h2>
      <p class="text-gray-400 text-sm leading-relaxed">
        Tesla Carview ist kostenlos und werbefrei. Falls du etwas zurückgeben möchtest,
        freuen sich diese Organisationen über deine Unterstützung.
      </p>
      <div class="space-y-3">
        <a v-for="org in donationOrgs" :key="org.name"
...
const donationOrgs = [
  {
    ...
    description: 'Bündnis von Hilfsorganisationen für schnelle und wirkungsvolle Katastrophenhilfe weltweit.',
    url: 'https://www.aktion-deutschland-hilft.de/de/spenden/',
  },
  {
    name: 'Lebenshilfe Rems-Murr',
    description: 'Unterstützung, Begleitung und Teilhabe für Menschen mit Behinderung im Rems-Murr-Kreis.',
    url: 'https://www.lebenshilfe-rems-murr.de/',
  },
  {
    name: 'Radio 7 Drachenkinder',
    description: 'Hilfe für schwer kranke Kinder in der Region – finanziert Therapien, Ausflüge und Wünsche.',
    url: 'https://www.radio7.de/drachenkinder/',
  },
];
