...
export const NAV_GROUPS = [
  ...
  // ── Auswertungen ──────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { key: 'dienstwagensteuer', to: '/dienstwagen-steuer', icon: 'wallet', emojiFallback: '🧾', label: 'Dienstwagen-Steuer', tooltip: '1-%-Regel vs. Fahrtenbuchmethode — geldwerter Vorteil inkl. E-Fahrzeug-Privileg (datumsabhängig)' },
